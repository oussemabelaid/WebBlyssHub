  ...
  <section class="contact-section section_padding">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-8">
          <form class="form-livraison" action="ajoutLivraison.php" method="post" id="livraisonForm">
            <div class="row">
               <div class="col-12">
                <div class="form-group">
                    <input class="form-control" name="iduser" id="iduser" type="text" placeholder = 'Enter your iduser'>
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">
                    <input class="form-control" name="adresse" id="adresse" type="text" placeholder = 'Enter your address'>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <input class="form-control" name="ville" id="ville" type="text" placeholder = 'Enter your city'>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <input class="form-control" name="region" id="region" type="text" placeholder = 'Enter your region'>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <input class="form-control" name="telephone" id="telephone" type="text" placeholder = 'Enter your phone number'>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
              ...
              <div class="col-12">
                <div class="form-group">
                    <textarea class="form-control" name="commentaire" id="commentaire" cols="30" rows="9" placeholder = 'Enter comment'></textarea>
                </div>
              </div>
            </div>
