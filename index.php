...
<body>
    ...
    <header class="header_area">
        <div style="margin-top: -51px;" class="sub_header">
            <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="single_service_part">
                        ...
                        <li><a href="about.html">Pet Surgeries</a></li>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single_service_part">
                        ...
                        <li><a href="about.html">Pet Adoption</a></li>
                        <p>Our free veterinary services are available to pets whose owners are on certain means-tested benefits.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="single_service_part">
                        ...
                        <li><a href="about.html">Pet care</a></li>
                        <p>Our free veterinary services are available to pets whose owners are on certain means-tested benefits.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-5 col-md-6">
                    <div class="counter_text">
                        ...
                        <a href="services.html" class="btn_1">Brows Now</a>
