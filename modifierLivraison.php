...
<form method="POST" >
 ...
 if(isset($_POST['edit']))
 {
   ...
   // var_dump($liv);
    ...
    header('Location: Gestiondeslivraisons.php');
    ...
    /**
      ...
      $nexmo_sms = new NexmoMessage('00466eb9','WkcGK1XJvRl4M1Mw');
    
      // Step 2: Use sendText( $to, $from, $message ) method to send a message. 
      $info = $nexmo_sms->sendText( '21658982464', 'zanimo', ' votre commande est livree' );
